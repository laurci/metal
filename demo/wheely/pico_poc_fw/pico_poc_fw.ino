...
void setup() {
  ...
  myController.setBias(50.0);                //255.0 / 2.0);
  myController.setWindUpLimits(-50, 50);  // Groth bounds for the integral term to prevent integral wind-up
...
void loop() {
  ...
  if ((mpuIntStatus & 0x10) || fifoCount == 1024) {
    ...
    double op = 0;
    if (ypr[2] * RADIANS_TO_DEGREES < 30 && ypr[2] * RADIANS_TO_DEGREES > -30) {

      input = ypr[2] * RADIANS_TO_DEGREES;
